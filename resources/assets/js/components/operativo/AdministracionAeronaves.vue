<template>
  <b-container fluid>
    ...
    <b-row>
      ...
      <b-col md="6" class="my-1">
         <b-btn v-b-modal.agregar variant="primary">Agregar Nueva Aeronave</b-btn>
      </b-col>
      <b-col md="6" class="my-1">
       ...
       <div class="row">
         ...
         <div class="form-group  col-sm-4">
              ...
              <b-form-input id="distancia"
                      type="text"
                      required
                      v-model="modalInfo.content.Matricula"
          ...
          <div class="form-group  col-sm-4">
              ...
              <b-form-input id="tarifa"
                      type="text"
                      required
                      v-model="modalInfo.content.Modelo"
           ...
           <div class="form-group  col-sm-4">
              ...
              <b-form-input id="tarifa"
                      type="text"
                      required
                      v-model="modalInfo.content.Capacidad"
                      placeholder="Inserte  Modelo">
              </b-form-input>
            </div>
...
export default {
  ...
  data () {
    return {
      ...
      fields: [
        ...
        { key: 'HorasUso',   label: 'Horas de Uso', sortable: true },
        { key: 'UsoPlanificado', label: 'Uso Planificado ', sortable: true },
        { key: 'Estado',    label: 'Estatus', sortable: true},
        { key: 'UltimoMantenimiento',  label: 'Fecha Ultimo Mantenimiento ',  sortable: true },   
  ...
  methods: {
    ...
    Cargadatos(ctx){
      axios.get("/aeronave/aeronaves").then(function(response){
    ...
    formatodatos(){
      ...
      for (var i= 0; i < this.data.length; i++){
        this.items.push({
          ...
          HorasUso: this.sumar(this.data[i].aehm),
          UsoPlanificado: this.sumar(this.data[i].aehp),
          UltimoMantenimiento: this.data[i].ultimo_mantenimiento,
          Modelo: this.data[i].modelo,
          Estado: this.data[i].estado,
          Capacidad: this.data[i].capacidad_asientos,
    ...
    actualizar(){
      ...
      axios({
        method: 'post',
        url: '/aeronave/aeronaves',
        data: {
          id: this.modalInfo.content.id,  
          matricula: this.modalInfo.content.Matricula,    
          modelo: this.modalInfo.content.Modelo, 
          capacidad: this.modalInfo.content.Capacidad,
        }
      }).then((response) =>{
        console.log(response.data);
    ...
    Deshabilitar(row){
     axios({
        method: 'post',
        url: '/aeronave/aeronaves/deshabilitar',
        data: {
          id: row.item.id,               
        }
      }).then((response)=>{
    ...
    Habilitar(row){
     axios({
        method: 'post',
        url: '/aeronave/aeronaves/habilitar',
        data: {
          id: row.item.id,               
        }
      }).then((response)=>{
