...
@section('content')
      ...
      <div class="row mb-2">
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            ...
            <img class="card-img-right flex-auto d-none d-lg-block" src="{{ asset('online/img/equipaje/permitido.jpg') }}" height="200px" alt="Eqipaje Permitido">
          </div>
        </div>
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            ...
            <img class="card-img-right flex-auto d-none d-lg-block" src="{{ asset('online/img/equipaje/peligroso.png') }}" height="190px" alt="Equipaje Peligroso">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row mb-2">
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            ...
            <img class="card-img-right flex-auto d-none d-lg-block" src="{{ asset('online/img/equipaje/mano.jpg') }}" height="150px" alt="Eqipaje de Mano Permitido">
          </div>
        </div>
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
    ...
    El usuario no debe incluir en su equipaje facturado, artículos frágiles o perecederos, tales como, dinero, joyas, piedras o metales preciosos, platería, documentos negociables, títulos u otros valores; dinero en efectivo, pasaportes, cámaras fotográficas o de video, filmadoras, computadoras, calculadoras, lentes, o botellas con licor, equipos médicos, teléfonos móviles, o cualquier otro objeto de valor o frágil, respecto de los cuales el transportista aéreo no se responsabiliza si se transporta en esas condiciones.</p>
            ...
            <img class="card-img-right flex-auto d-none d-lg-block" src="{{ asset('online/img/equipaje/facturado.png') }}" height="200px" alt="Equipaje Facturado">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6 ">
          ...
          <p class="card-text mb-auto text-justify"> 
            ...
            <img class="card-img-right flex-auto d-none d-lg-block" src="{{ asset('online/img/equipaje/importante.jpg') }}" height="150px" alt="Equipaje Peligroso">
          </div>
        </div>
      </div>
    </div>
