...
<a class="btn btn-md btn-info btncosto" style="margin-left: 75px;" href="{{ URL::to('/online/cliente/ModificarPerfil', Auth::guard('online')->user()->id) }}" class="thbtn"> <strong>Modificar</strong></a>
     ...
     <div class="card-detalles">
      <div class="row sm-8">
       ...
       <div class="vermas mb-5">
        <a  class="btn btn-md btn-primary btncosto mr-5" role="tab" id="headingOne" data-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                <h6 class="mb-0">
                   Historicos de boletos <i class="fa fa-arrow-circle-down"></i>
                </h6>
            </a>

         {{-- Boletos Reservados

         <a class="btn btn-md btn-primary btncosto mr-5" role="tab" id="headingTwo" class="collapsed" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                <h6 class="mb-0">
                    Boletos Reservados <i class="fa fa-arrow-circle-down"></i>
                </h6>
            </a> --}}
            
            <a class="btn btn-md btn-primary btncosto mr-5" role="tab" id="headingTwo" class="collapsed" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                <h6 class="mb-0">
                   Boletos Pagados <i class="fa fa-arrow-circle-down"></i>
                </h6>
            </a>

            <a class="btn btn-md btn-primary btncosto mr-5" role="tab" id="heading3" class="collapsed" data-toggle="collapse" href="#collapse3" aria-expanded="false" aria-controls="collapse3">
                <h6 class="mb-0">
                  Boletos Chequeados <i class="fa fa-arrow-circle-down"></i>
                </h6>
            </a>
         </div> 

          <div id="collapseOne" class="collapse show " role="button" aria-labelledby="headingOne" data-parent="#accordionEx" >
              ...
              <tbody>
                <tr>
                  ...
                  @if($boleto->estatus == 'Pagado')
                      <td> <p class="badge badge-danger badge-pill"> {{ $boleto->estatus }} </p></td>
  ...
  <div class="modal fade" id="chequeo{{ $boleto->boleto_id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            @endif
                  ...
                  @if(($boleto->estatus == 'Reservado'))
                    <td> <p class="badge badge-primary badge-pill"> {{ $boleto->estatus }} </p></td>
    ...
    <div id="collapseTwo" class="collapse" role="button" aria-labelledby="headingTwo" data-parent="#accordionEx" >
           
     <h5>Tus Boletos Comprados </h5>
                   <table class="table table-md table-hover text-center ">
            <thead>
              <tr class="table-detalles2">
                <th scope="col"><strong>Pasajero</strong></th>
                <th scope="col"><strong>Documento: </strong></th>
                <th scope="col"><strong>N°Vuelo:</strong></th>
                <th scope="col"><strong>Desde: CCS</strong></th>
                <th scope="col"><strong>Hasta: CUM</strong></th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td ></td>
                <td > <button class="btn btn-primary btn-md " 
              data-toggle="modal" data-target="#exampleModal" type="submit">Pagar </button> </td>
              </tr>             
            </tbody>
          </table>
          <hr class="mb-4">
...
<!-- <article class="card"> -->
<div class="card-body">
<p> <img src="img/pago/pay-visa.png"> 
   <img src="img/pago/pay-mastercard.png"> 
   <img src="img/pago/pay-american-ex.png">
   <img src="img/pago/pay-visa-el.png">
</p>
<!-- <p class="alert alert-success">ingrese los datos correctamnete</p> -->
...
<div class="input-group">
  ...
  <input type="text" class="form-control" name="cardNumber" id="cc-number" placeholder="">
  <div class="invalid-feedback">
                  Requiere el numero de tarjeta
                </div>
</div> <!-- input-group.// -->
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <label data-toggle="tooltip" title="" data-original-title="3 digits code on back side of the card">CVV <i class="fa fa-question-circle"></i></label>
            <input class="form-control" required="" type="text" id="cc-cvv">
        </div> <!-- form-group.// -->
         <div class="invalid-feedback">
                 es necesario el CVV
                </div>
