      ...
      <div class="row mb-2">
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            ...
            <img class="card-img-right flex-auto d-none d-lg-block" src="{{ asset('online/img/documentacion/discapacitados.png') }}" height="150px" alt="Discapacitados">
          </div>
        </div>
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            ...
            <img class="card-img-right flex-auto d-none d-lg-block" src="{{ asset('online/img/documentacion/am.png') }}" height="145px" alt="Adultos Mayores">
          </div>
        </div>
      </div>
    ...
    <div class="row mb-3">
        <div class="col-md-4">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            ...
            <img class="card-img-right flex-auto d-none d-lg-block" src="{{ asset('online/img/documentacion/ley.jpg') }}" height="70px" alt="Leyes">
          </div>
        </div>
        <div class="col-md-4">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            ...
            <img class="card-img-right flex-auto d-none d-lg-block" src="{{ asset('online/img/documentacion/ninos.jpg') }}" height="80px" alt="Niños">
          </div>
        </div>
        <div class="col-md-4">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            ...
            <img class="card-img-right flex-auto d-none d-lg-block" src="{{ asset('online/img/documentacion/pass.jpg') }}" height="90px" alt="Pasaporte">
          </div>
        </div>
      </div>
