...
<div class="card border-primary border-bottom-0 mb-3">
      <div class="card-header view overlay" id="grad1" id="joder" >
        <div class="py-2 text-center box wow flipInX" data-wow-duration="0.8s">
          <img class=" mx-auto img-fluid" src="{{ asset('img/logo.png') }}" width="150px" height="100px">
...
<!-- <article class="card"> -->
<div class="card-body">
<p> <img src="{{ asset('img/pago/pay-visa.png') }}"> 
   <img src="{{ asset('img/pago/pay-mastercard.png') }}"> 
   <img src="{{ asset('img/pago/pay-american-ex.png') }}">
   <img src="{{ asset('img/pago/pay-visa-el.png') }}">
</p>
