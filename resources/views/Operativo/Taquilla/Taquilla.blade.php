          ...
          <div class="col-md-7"><!-- TAQUILLA -->
            <div class="card">
              ...
              <div class="card-body">
               ...
               <div id="soloida">
               {!! Form::open(['route' => ['operativo.CompraBoleto'], 'method' => 'GET', 'id'=> 'FormIda']) !!}
               <input type="hidden" name="tipo" id="tipo" value="1">
                 @include('operativo.taquilla.ida')
                 <div class="card-footer text-center">
                <button type="submit" id="btnIda" class="btn  btn-primary" name="btn_ida" disabled >
               ...
               <div id="idayvuelta">
               {!! Form::open(['route' => ['operativo.CompraBoleto'], 'method' => 'GET', 'id'=> 'FormIdayVuelta']) !!}
               <input type="hidden" name="tipo" id="tipo" value="2">
                   @include('operativo.taquilla.idayvuelta')
                   <div class="card-footer text-center">
                <button type="submit" id="btnIdayVuelta" class="btn  btn-primary" name="btn_idayvuelta" disabled>
                  <i class="fa fa-dot-circle-o"> Aceptar</i>
                </button>
                <button type="reset " class="btn  btn-danger" >
                  <i class="fa fa-ban"> Cancelar</i>
               ...
               <div id="multidestino">
               {!! Form::open(['route' => ['operativo.CompraBoleto'], 'method' => 'GET', 'id'=> 'FormMultidestino']) !!}
               ...
               <input type="hidden" name="cantidadV" id="cantidadV" value="2">
                   ...
                   <div class="card-footer text-center">
                <button type="submit" id="btnMultidestino"  class="btn  btn-primary" name="btn_multidestino" disabled>
                  <i class="fa fa-dot-circle-o"> Aceptar</i>
                </button>
                <button type="reset " class="btn  btn-danger" >
                  <i class="fa fa-ban"> Cancelar</i>
