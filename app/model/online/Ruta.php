...
class Ruta extends Model
{
    ...
    {
    	return $this->belongsTo('App\Model\Online\Segmento');
    }

    public function sucursal()
    {
    	return $this->belongsTo('App\Model\Online\Sucursal');
    }

    public function origen()
    {
      return $this->belongsTo('App\Model\Online\Sucursal','origen_id','id');
    }
    public function destino()
    {
      return $this->belongsTo('App\Model\Online\Sucursal','destino_id','id');
    }
