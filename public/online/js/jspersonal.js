...
function insertarInput(){
	...
	var ninos=parseInt(document.getElementById('inputninos').value);
	 var elemento='<div class="form-check form-check-inline pt-1 pb-1"><label class="form-check-label text-white" for="inlineRadio1">Los niños mayores de 2 años deben ir sentados.</label></div><div class="form-row">';
