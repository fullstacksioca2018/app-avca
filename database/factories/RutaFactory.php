...
$factory->define(App\Ruta::class, function (Faker $faker) {
    ...
    if($random_origen != $random_destino){
        return [
            ...
            'sigla'  => App\Sucursal::find($random_origen)->sigla.'-'.App\Sucursal::find($random_destino)->sigla,
            'origen_id' => App\Sucursal::find($random_origen)->id,
            'destino_id' => App\Sucursal::find($random_destino)->id,
